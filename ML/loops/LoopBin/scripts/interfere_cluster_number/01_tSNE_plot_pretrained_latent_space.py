...
scatter = plt.scatter(latent_tsne[:, 0], latent_tsne[:, 1], cmap='viridis', s=50, alpha=0.7)
# Add a legend
plt.legend(*scatter.legend_elements())
plt.title('t-SNE plot of the latent space')
plt.xlabel('t-SNE component 1')
plt.ylabel('t-SNE component 2')
pdf = '/usr/users/yzhu1/LoopBin/trials/saved_models/pretrain_ae_control_rep1_H3K4me1/tSNE_latant.pdf'
plt.savefig(pdf)
plt.close()
