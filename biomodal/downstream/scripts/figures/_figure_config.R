# scripts/figures/_figure_config.R
# =============================================================================
# Shared publication-figure utilities for the BAP1 methylation paper.
#
# Sourced by every consolidated figure script (figure1..figure7 + figureS1)
# AFTER scripts/viz_sections/_shared_config.R. By the time this file is
# sourced, the following are already in scope and MUST NOT be reloaded:
...
# All consolidated figure outputs live under plots/figures/ (separate from the
# per-section plots/visualizations/ tree). _shared_config.R does NOT create
# this directory, so we create it (and its tables/ subfolder) here.
FIGURE_DIR        <- file.path(BASE_DIR, "plots/figures")
FIGURE_TABLES_DIR <- file.path(FIGURE_DIR, "tables")

dir.create(FIGURE_DIR,        recursive = TRUE, showWarnings = FALSE)
dir.create(FIGURE_TABLES_DIR, recursive = TRUE, showWarnings = FALSE)
...
# -----------------------------------------------------------------------------
cat("Loaded _figure_config.R - publication figure utilities available:\n")
