# scripts/figures/figure5_mecp2_chromatin_reader.R
# =============================================================================
...
# =============================================================================
cat("Composing Figure 5 (design AABB / CCDD / EEEE)...\n")

design <- "AABB\nCCDD\nEEEE"

figure5 <- panel_a + panel_b + panel_c + panel_d + panel_e +
  plot_layout(design = design, heights = c(1, 1, 0.8))

# Single plot_annotation() carries both the bold A-E panel tags and the figure
# title so neither overrides the other (successive annotations otherwise merge).
figure5 <- figure5 +
  patchwork::plot_annotation(
    tag_levels = "A",
    title = "Figure 5. MeCP2 reads chromatin state, not DNA methylation",
    theme = theme(plot.title = element_text(face = "bold", size = 11, hjust = 0))
  )

# =============================================================================
# Save composite (PDF + SVG + JPG) at the plan's dimensions (180 x 200 mm).
# Useful sub-panels are also saved standalone for flexible figure assembly.
# =============================================================================
cat("Saving Figure 5 composite (180 x 200 mm) ...\n")
save_figure(figure5, "figure5_mecp2_chromatin_reader",
            width_mm = 180, height_mm = 200)

cat("Saving Figure 5 sub-panels ...\n")
save_figure(panel_a, "figure5_panelA_model_r2",        width_mm = 90, height_mm = 85)
save_figure(panel_b, "figure5_panelB_variance",        width_mm = 90, height_mm = 85)
save_figure(panel_c, "figure5_panelC_k119ub_by_mecp2", width_mm = 90, height_mm = 85)
save_figure(panel_d, "figure5_panelD_mirror_profiles", width_mm = 90, height_mm = 85)
save_figure(panel_e, "figure5_panelE_ratio_variance",  width_mm = 180, height_mm = 60)

cat("\n=== Figure 5 complete ===\n")
cat("Output: ", file.path(FIGURE_DIR, "figure5_mecp2_chromatin_reader"), "\n", sep = "")
