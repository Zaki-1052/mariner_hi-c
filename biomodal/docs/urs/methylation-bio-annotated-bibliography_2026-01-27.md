...
| No coordinated mC↑/hmC↓ pattern described | ✓ 84.6% concordance |
...
- [ ] 84.6% of genes significant in both modifications show coordinated mC↑/hmC↓
- [ ] Gene bodies (not promoters) are primary affected regions
- [ ] Active Promoter chromatin states preferentially affected (94% of Active_Promoter DMRs are hypermethylated)
- [ ] Top hit is Syt1 (synaptic transmission) with +17.9% mC / -15.3% hmC
...
- [ ] CAN claim: Coordinated methylation pattern exists and is highly reproducible (85%)
