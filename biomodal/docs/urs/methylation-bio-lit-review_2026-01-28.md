...
### Your Key Results
1. **5,708 genes** show a coordinated pattern: **5mC increases while 5hmC decreases** at the same loci
2. This represents **84.6%** of genes significant in both modifications
3. **Syt1 (Synaptotagmin-1)** is the most affected gene (+17.9% mC, -15.3% hmC)
4. **49.9%** of significant DMRs occur at **Active Promoter** chromatin states
...
| 85% concordance rate | **NOVEL** | Remarkably high coordination |
...
| Metric | 5mC | 5hmC |
|--------|-----|------|
| Genes tested | 20,979 | 20,979 |
| Significant (q < 0.05) | 8,836 (42.1%) | 9,930 (47.3%) |
| Direction bias | **75% hypermethylated** | **87% decreased** |
| Mean change | **+2.27%** | **-2.08%** |

### The Coordinated Pattern

- **6,750 genes** are significant in both 5mC AND 5hmC
- **5,708 genes (84.6%)** show the **mC↑ / hmC↓ pattern**
- 1,042 genes (15.4%) show the opposite pattern

### Most Affected Genes

| Gene | mC Change | hmC Change | Function |
|------|-----------|------------|----------|
| **Syt1** | +17.9% | -15.3% | Synaptic vesicle exocytosis, Ca2+ sensor |
| Tmem238 | +20.3% | -11.1% | Transmembrane protein |
| Sap30 | +22.4% | -6.3% | Sin3A-associated protein, chromatin |
| Gclm | +16.3% | -11.4% | Glutamate-cysteine ligase, antioxidant |
| Mcu | +14.7% | -9.8% | Mitochondrial calcium uniporter |

### Chromatin State Distribution

- **49.9% at Active Promoter** regions
- 94.0% of Active Promoter DMRs are hypermethylated
- 93.8% of Repressed Promoter DMRs are hypomethylated
...
**Your data shows**: 49.9% of DMRs occur at Active Promoter chromatin states, consistent with effects on actively transcribed chromatin.
...
**The 84.6% concordance rate is remarkable** - this is not random dysregulation but a highly specific, coordinated response.
...
- 49.9% of DMRs at Active Promoter states
- 94.0% of Active Promoter DMRs are hypermethylated
- 93.8% of Repressed Promoter DMRs are hypomethylated
...
**Why this is novel**: The extreme coordinated changes at specific genes (Syt1: 33.2% combined, Tmem238: 31.4% combined) represent some of the largest methylation changes reported in a BAP1 model.

**Syt1 as the top hit is particularly significant** (+17.9% mC, -15.3% hmC, 33.2% combined):
...
1. **The coordinated mC↑/hmC↓ signature** - 84.6% concordance is remarkable
