...
Your data shows DMRs predominantly at **gene bodies (42-47% significant)** with almost nothing at promoters. This matches exactly where brain 5hmC biology operates.
...
Your data shows exactly this pattern at **84.6% of genes significant in both modifications**. That concordance rate is not what you'd expect from random dysregulation—it's the signature of a specific mechanism (blocked first step of demethylation).
...
*(84.6% concordance in deep-seq data)*
...
Your data shows predominant **hypermethylation at Active Promoter chromatin states** (94% of Active_Promoter DMRs are hypermethylated). This is consistent with the euchromatin hypermethylation pattern, though the mechanism may differ (BAP1 → TET block vs. direct TET loss).
...
- This pattern affects 85% of genes with changes in both modifications
...
| 85% concordance rate | **Novel** (suggests specific mechanism) |
