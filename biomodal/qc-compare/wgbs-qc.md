...
Quality scores are excellent across the board:

### Q20 / Q30 Summary

| Sample    | Total Reads | >= Q20    | >= Q30    |
| --------- | ----------- | --------- | --------- |
| ctrl_3139 | 33.5M       | **99.7%** | **95.0%** |
| ctrl_3200 | 27.5M       | **99.7%** | **95.9%** |
| mut_3201  | 8.7M        | **99.7%** | **96.5%** |
| mut_3391  | 27.1M       | **99.7%** | **95.3%** |

**99.7% of all reads are Q20+** and **95-96.5% are Q30+** across every sample. These are very strong numbers -- well above the typical thresholds for high-quality data (>85% Q30 is generally considered good for Illumina). Per-base mean quality stays above Q37 even at the 3' ends where quality typically drops, so there's essentially no low-quality tail to worry about.

Sequencing quality is not a concern here at all -- the limiting factor for this run is depth/coverage, not base quality.
