The plan creates section_47_ctcf_anchor_methylation_overlay.R with 5 sub-analyses that directly overlay your biomodal 5mC/5hmC data onto CTCF
   loop anchors:                                                                                                                               
       
  - 47a: Core test — are CpG islands at lost CTCF anchors hypermethylated? (Fisher's + Wilcoxon)                                               
  - 47b: Multi-region comparison across CpG islands/shores/shelves/promoters                                                                   
  - 47c: Coordinated mC-up/hmC-down (TET blockade signature) at CTCF anchor CpG islands                                                        
  - 47d: Distance-stratified analysis with Cochran-Mantel-Haenszel test (controls the loop length confound)                                    
  - 47e: Correlation between methylation effect size and loop logFC                                                                            
                                                                                                                                               
  The key mechanistic test is the CMH in 47d — if the hypermethylation signal at lost CTCF anchors survives distance stratification, it's an   
  independent effect paralleling the Bernstein IDH finding.
