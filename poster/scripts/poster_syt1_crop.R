...
OUT_DIR    <- file.path(REPO_ROOT, "poster/figures/syt1_locus_original_colors")
dir.create(OUT_DIR, recursive = TRUE, showWarnings = FALSE)

LOOP_FILE  <- file.path(REPO_ROOT, "peaks/loop_annotation_extended/late/extended_characterized_loops.tsv")
...
loops_df <- read.table(LOOP_FILE, header = TRUE, sep = "\t",
...
cat("\nRendering (original colors, thick arcs)...\n")
save_variant(OUT_DIR, "Syt1_locus_poster_v2")
