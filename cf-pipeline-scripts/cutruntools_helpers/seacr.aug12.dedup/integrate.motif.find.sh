...
workdir=`pwd`
fname=`basename $i _treat.stringent.sort.bed`
peak=$fname"_treat.stringent.sort.bed"
summit=$fname"_treat.stringent.sort.summits.bed"
summitfa=$fname"_treat.stringent.sort.summits_padded.fa"
