...
bt2idx=/home/ubuntu/cutruntools/assemblies/chrom.mm10
...
>&2 date
$bowtie2bin/bowtie2 -p 16 --dovetail --phred33 -x $bt2idx/mm10 -1 $trimdir2/"$base"_1.paired.fastq.gz -2 $trimdir2/"$base"_2.paired.fastq.gz > $aligndir/"$base"_aligned_reads.sam 2> $logdir/"$base".bowtie2 
