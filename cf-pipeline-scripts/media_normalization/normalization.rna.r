...
samples<-c("1M_ctrl_S73Aligned.sortedByCoord.out.bam", "1M_KO_S74Aligned.sortedByCoord.out.bam")
...
#write.csv(covgf,file="/media/rs_256/normalization/raw.csv", row.names=TRUE)

#make scatterplots of raw, non-normalized data
cat("plotting before normalization\n")
pdf(paste0(dir,"scatterplots_1Mctrl_1MKO.pdf"))
...
#write.csv(covgfn,file="/media/rs_256/normalization/normalized.csv", row.names=TRUE)

#scatterplots after 99%-ile normalization
cat("plotting after normalization\n")
pdf(paste0(dir,"scatterplots_1Mctrl_1MKO_norm.pdf"))
