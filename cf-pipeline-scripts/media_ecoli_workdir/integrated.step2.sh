...
chromsizedir=`dirname /home/ubuntu/cutruntools/assemblies/chrom.ecoli/ecoli.fa`
...
$extratoolsbin/bedGraphToBigWig $outdir/"$base_file".sort.bdg $chromsizedir/ecoli.chrom.sizes $outdir/"$base_file".sorted.bw
rm -rf "$base_file".sort.bdg

cd $outdir2
LC_ALL=C sort -k1,1 -k2,2n $outdir2/"$base_file"_treat_pileup.bdg > $outdir2/"$base_file".sort.bdg
$extratoolsbin/bedGraphToBigWig $outdir2/"$base_file".sort.bdg $chromsizedir/ecoli.chrom.sizes $outdir2/"$base_file".sorted.bw
rm -rf "$base_file".sort.bdg
