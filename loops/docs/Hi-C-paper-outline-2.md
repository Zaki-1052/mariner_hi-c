...
- GENOVA insulation plot \- Differential TAD boundaries  
  - Perhaps put numbers/volcano in supplementary  
- % of genome with differential PC1 (pie chart?)  
  - Smaller contact map of obvious differential region  
  - Sig weakened A cmpt PC1, Sig weakened B cmpt PC1, Flipped PC1 (complete \+PC1 → \-PC1 and vice versa), no change  
...
- APA analysis at both timepoints \- GENOVA  
