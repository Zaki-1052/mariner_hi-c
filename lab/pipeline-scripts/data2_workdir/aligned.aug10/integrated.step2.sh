...
unset PYTHONPATHintegrated.step2.sh 
...
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdir -q 0.01 -B --SPMR --keep-dup all 2> $logdir/"$base_file".macs2
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdir2 -q 0.01 -B --SPMR 2> $logdir/"$base_file".dedup.macs2

#broad peak calls
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdirbroad --broad --broad-cutoff 0.1 -B --SPMR --keep-dup all 2> $logdir/"$base_file".broad.all.frag.macs2
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdirbroad2 --broad --broad-cutoff 0.1 -B --SPMR 2> $logdir/"$base_file".broad.all.frag.dedup.macs2
...
$extratoolsbin/bedGraphToBigWig $outdir2/"$base_file".sort.bdg $chromsizedir/mm10.chrom.sizes $outdir2/"$base_file".sorted.bw
rm -rf "$base_file".sort.bdg
...
#broad peak calls
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdirbroad --broad --broad-cutoff 0.1 -B --keep-dup all 2> $logdir/"$base_file".broad.all.frag.macs2
$macs2bin/macs2 callpeak -t $workdir/$dir/"$base_file".bam -g mm -f BAMPE -n $base_file --outdir $outdirbroad2 --broad --broad-cutoff 0.1 -B 2> $logdir/"$base_file".broad.all.frag.dedup.macs2
$pythonbin/python $extratoolsbin/get_summits_broadPeak.py $outdirbroad/"$base_file"_peaks.broadPeak|$bedopsbin/sort-bed - > $outdirbroad/"$base_file"_summits.bed
$pythonbin/python $extratoolsbin/get_summits_broadPeak.py $outdirbroad2/"$base_file"_peaks.broadPeak|$bedopsbin/sort-bed - > $outdirbroad2/"$base_file"_summits.bed
