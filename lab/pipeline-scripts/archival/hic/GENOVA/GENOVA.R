...
cat ("Enter the path/to/file of the control balanced cool file:")
WT_filepath <- readLines("stdin", n=1)
cat ("Enter the path/to/file of the mutant balanced cool file:")
KO_filepath <- readLines("stdin", n=1)
