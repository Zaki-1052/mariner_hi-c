...
dir<-"/data/rs_256/genomewide_plots/250206_UbHist_DESeq_norm_input/"
cat("workdir: ", dir, "\n")
...
for (i in 1 : num_bw)
{
	cat("Enter BigWig number ", i, ": (without .bw in the file name)")
	samples <- append(samples, readLines("stdin", n=1))
	cat("\n")
}
cat(samples)
