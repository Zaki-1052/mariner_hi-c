...
len=`cat length`
trimdir=$atac_workdir/trimmed
trimdir2=$atac_workdir/trimmed3
logdir=$atac_workdir/logs
aligndir=$atac_workdir/aligned.aug10
...
>&2 date
$javabin/java -jar $trimmomaticbin/$trimmomaticjarfile PE -threads 16 -phred33 $dirname/"$base"_R1_001.fastq.gz $dirname/"$base"_R2_001.fastq.gz $trimdir/"$base"_1.paired.fastq.gz $trimdir/"$base"_1.unpaired.fastq.gz $trimdir/"$base"_2.paired.fastq.gz $trimdir/"$base"_2.unpaired.fastq.gz ILLUMINACLIP:$adapterpath/NexteraPE-PE.fa:2:30:10:8:true LEADING:20 TRAILING:20 SLIDINGWINDOW:4:15 MINLEN:25
